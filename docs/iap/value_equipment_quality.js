module.exports = {
  get: {
    tags: ["Value Pack"],
    summary: "Get Value Equipment Quality Up Pack",
    parameters: [
      {
        name: "x-access-token",
        in: "header",
              ...
              data: [
                {
                  pack_id: 3000180,
                  iap_id: "",
                  pack_name: "Value Equipment Quality Up",
                  price: {
                  ...
                  equipment_quality_expiry: 1690939478,
                },
              ],
            },
          },
  ...
  post: {
    tags: ["Value Pack"],
    summary: "Buy Value Equipment Quality Up Pack",
    parameters: [
      {
        name: "x-access-token",
        in: "header",
